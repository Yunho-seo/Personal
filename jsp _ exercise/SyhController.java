...
public class SyhController {
	...
	@RequestMapping(value = "syh/testPageJstl.do")
	public ModelAndView testPageJstl() {
		ModelAndView mav = new ModelAndView();

		mav.setViewName("testPageJstl");
		return mav;
	}
	...
	@RequestMapping(value = "syh/checkValueList.do", produces = "application/json; charset=utf-8"
			, consumes = "application/json")
	// 응답 데이터 타입, 요청 데이터의 타입을 Ajax와 맞춰주어야 한다.
	@ResponseBody
	public List<Integer> checkValueList(@RequestBody List<Integer> checkValueList) {
